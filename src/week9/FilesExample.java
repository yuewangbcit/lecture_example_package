...
//        Path path1 = Path.of("src/src.week9/employee2.txt");
...
//        Path path2 = Path.of("src/src.week9/employee3.txt");
//        try {
...
//        Path path3 = Path.of("src/src.week9/employee3.txt");
...
//        Path path4 = Path.of("src/src.week9");
...
//        try {
//            Path utfFile = Files.createTempFile("some", ".txt");
//            Files.move(utfFile, Path.of("src/src.week9").resolve(utfFile.getFileName().toString()));
//        } catch (IOException ex) {
//            ex.printStackTrace();
//        }
...
//        }
        ...
        Path path5 = Path.of("src/src.week9/123");
...
//            new ObjectOutputStream(new FileOutputStream("src/src.week9/object.txt"))) {
